...
-- Started on 2024-01-22 01:06:13
...
--
-- TOC entry 248 (class 1259 OID 33565)
...
--
-- TOC entry 238 (class 1259 OID 25360)
...
CREATE TABLE public.ohd_meter (
    ...
    contract_proof_document bigint NOT NULL,
...
--
-- TOC entry 239 (class 1259 OID 25361)
...
--
-- TOC entry 240 (class 1259 OID 25362)
...
--
-- TOC entry 246 (class 1259 OID 25373)
...
--
-- TOC entry 247 (class 1259 OID 25398)
...
--
-- TOC entry 241 (class 1259 OID 25363)
...
--
-- TOC entry 242 (class 1259 OID 25364)
...
CREATE TABLE public.ohd_user (
    ...
    mobile_country_code smallint NOT NULL,
    company_id bigint NOT NULL,
...
--
-- TOC entry 244 (class 1259 OID 25366)
...
--
-- TOC entry 245 (class 1259 OID 25367)
...
--
-- TOC entry 4971 (class 0 OID 25125)
-- Dependencies: 223
-- Data for Name: ohd_company; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.ohd_company (id, name, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (1, 'Ontec', 1, NULL, NULL);


--
-- TOC entry 4970 (class 0 OID 25113)
-- Dependencies: 222
...
--
-- TOC entry 4969 (class 0 OID 25096)
-- Dependencies: 221
-- Data for Name: ohd_document; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.ohd_document (id, document_type, url, title, extension, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (1, 1, 'https://bill1', 'Water bill', 'pdf', 1, NULL, NULL);
INSERT INTO public.ohd_document (id, document_type, url, title, extension, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (2, 2, 'https://bill2', 'Electrical bill', 'pdf', 1, NULL, NULL);


--
-- TOC entry 4968 (class 0 OID 25084)
-- Dependencies: 220
-- Data for Name: ohd_document_type; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.ohd_document_type (id, name, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (1, 'Water bill', 1, NULL, NULL);
INSERT INTO public.ohd_document_type (id, name, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (2, 'Electrical bill', 1, NULL, NULL);


--
-- TOC entry 4966 (class 0 OID 25056)
-- Dependencies: 218
...
INSERT INTO public.ohd_enum_meter_type (id, name, display_value, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (1, 'Gas', 'Gas', 1, NULL, NULL);
INSERT INTO public.ohd_enum_meter_type (id, name, display_value, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (2, 'Water', 'Water', 1, NULL, NULL);
INSERT INTO public.ohd_enum_meter_type (id, name, display_value, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (3, 'Electricity', 'Electricity', 1, NULL, NULL);


--
-- TOC entry 4963 (class 0 OID 25019)
-- Dependencies: 215
...
INSERT INTO public.ohd_enum_status (id, name, display_value, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (2, 'InComplete', 'Waiting for complete', NULL, NULL);
...
--
-- TOC entry 4965 (class 0 OID 25042)
-- Dependencies: 217
...
--
-- TOC entry 4967 (class 0 OID 25072)
-- Dependencies: 219
-- Data for Name: ohd_enum_user_relation; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.ohd_enum_user_relation (id, name, display_name, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (1, 'tenants', 'Tenants', 1, NULL, NULL);
INSERT INTO public.ohd_enum_user_relation (id, name, display_name, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (2, 'Owner', 'Owner', 1, NULL, NULL);
...
INSERT INTO public.ohd_meter (id, property_id, meter_number, meter_type_id, meter_alias, daily_target_consumption, tax_number, contract_proof_document, contract_end_date, address_line_1, address_line_2, city, state, country, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (1, 5, '123456', 1, 'test type', 123, 123, 1, '2025-12-31 00:00:00', 'Pune', 'pune', 'pune', 'Maharashtra', 'India', 1, NULL, NULL);


--
-- TOC entry 4972 (class 0 OID 25137)
-- Dependencies: 224
-- Data for Name: ohd_mobile_country_code; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.ohd_mobile_country_code (id, code, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (1, '91', 1, NULL, NULL);
...
INSERT INTO public.ohd_otp ("Id", "Otp", "Email", "StatusId", created_at, modified_at, "CountryCodeId", "companyId", "MobileNumber") OVERRIDING SYSTEM VALUE VALUES (6, '123456', 's@h.k', 4, '2024-01-03 21:48:32.556959', '2024-01-03 21:48:32.556965', 1, 1, '9011619932');
INSERT INTO public.ohd_otp ("Id", "Otp", "Email", "StatusId", created_at, modified_at, "CountryCodeId", "companyId", "MobileNumber") OVERRIDING SYSTEM VALUE VALUES (7, '123456', 'shital@gmail.com', 4, '2024-01-04 18:52:28.690725', '2024-01-04 18:52:28.695052', 1, 1, '9552109391');


--
-- TOC entry 4976 (class 0 OID 25223)
-- Dependencies: 228
-- Data for Name: ohd_property; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.ohd_property (id, name, unit_number, owner_id, company_id, status_id, address_lattitude, address_longitude, address_line_1, address_line_2, city, state, country, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (6, 'Office', '1228', 3, 1, 1, NULL, NULL, 'Hinjewadi', 'Hinjewadi', 'Pune', 'Maharashtra', 'India', NULL, NULL);
INSERT INTO public.ohd_property (id, name, unit_number, owner_id, company_id, status_id, address_lattitude, address_longitude, address_line_1, address_line_2, city, state, country, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (8, 'Home2', '9865', 3, 1, 1, NULL, NULL, 'pune', 'pune', 'pune', 'pune', 'India', '2024-01-04 14:21:13', '2024-01-04 14:21:13');
INSERT INTO public.ohd_property (id, name, unit_number, owner_id, company_id, status_id, address_lattitude, address_longitude, address_line_1, address_line_2, city, state, country, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (15, 'Home3', '5689', 3, 1, 1, NULL, NULL, 'pune', 'pune', 'pune', 'pune', 'pune', '2024-01-04 20:29:08.282926', '2024-01-04 20:13:19.289');
INSERT INTO public.ohd_property (id, name, unit_number, owner_id, company_id, status_id, address_lattitude, address_longitude, address_line_1, address_line_2, city, state, country, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (16, 'Home4', '5699', 3, 1, 1, NULL, NULL, 'pune', 'pune', 'pune', 'pune', 'pune', '2024-01-04 20:30:12.675129', '2024-01-04 20:13:19.289');
INSERT INTO public.ohd_property (id, name, unit_number, owner_id, company_id, status_id, address_lattitude, address_longitude, address_line_1, address_line_2, city, state, country, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (19, 'Home6', '5589', 3, 1, 1, NULL, NULL, 'pune', 'pune', 'pune', 'pune', 'pune', '2024-01-04 20:43:51.358881', '2024-01-04 20:13:19.289');
INSERT INTO public.ohd_property (id, name, unit_number, owner_id, company_id, status_id, address_lattitude, address_longitude, address_line_1, address_line_2, city, state, country, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (23, 'Home3', '5669', 3, 1, 1, NULL, NULL, 'pune', 'pune', 'pune', 'pune', 'pune', '2024-01-04 20:58:20.366899', '2024-01-04 20:13:19.289');
INSERT INTO public.ohd_property (id, name, unit_number, owner_id, company_id, status_id, address_lattitude, address_longitude, address_line_1, address_line_2, city, state, country, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (5, 'Home', '9324', 3, 1, 1, NULL, NULL, 'Pune', 'Pune', 'Chinchwad', 'Maharashtra', 'India', NULL, NULL);


--
-- TOC entry 4977 (class 0 OID 25297)
-- Dependencies: 229
...
--
-- TOC entry 4975 (class 0 OID 25169)
-- Dependencies: 227
-- Data for Name: ohd_user; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.ohd_user (id, title, first_name, last_name, mobile_country_code, company_id, mobile, email, password, role_id, address_line_1, address_line_2, city, state, country, communication_setting, status_id, created_at, modified_at, address_lattitude, address_longitude) OVERRIDING SYSTEM VALUE VALUES (5, NULL, NULL, NULL, 1, 1, '9552109391', 'shital@gmail.com', 'GctGUspVCKk4FaEszJDFUyHgJlLCdhCp4bnAHLkdTf0=', 1, NULL, NULL, NULL, NULL, NULL, NULL, 4, '2024-01-04 18:57:21.942163', '2024-01-04 18:57:22.597512', NULL, NULL);
INSERT INTO public.ohd_user (id, title, first_name, last_name, mobile_country_code, company_id, mobile, email, password, role_id, address_line_1, address_line_2, city, state, country, communication_setting, status_id, created_at, modified_at, address_lattitude, address_longitude) OVERRIDING SYSTEM VALUE VALUES (3, 2, 'Chetan', 'Patil', 1, 1, '1234567890', 'shital.patil47@gmail.com', 'GctGUspVCKk4FaEszJDFUyHgJlLCdhCp4bnAHLkdTf0=', 1, 'India', 'Pune', 'Pune', 'Maharashtra', 'India', 1, 1, '2023-12-29 17:48:20.288358', '2024-01-21 21:55:52.102917', NULL, NULL);


--
-- TOC entry 4973 (class 0 OID 25149)
-- Dependencies: 225
-- Data for Name: ohd_user_communication_setting; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.ohd_user_communication_setting (id, user_id, communication_id, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (1, 3, 1, 1, NULL, NULL);
INSERT INTO public.ohd_user_communication_setting (id, user_id, communication_id, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (2, 3, 2, 1, NULL, NULL);


--
-- TOC entry 4974 (class 0 OID 25157)
-- Dependencies: 226
-- Data for Name: ohd_user_role_master; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.ohd_user_role_master (id, name, description, status_id, created_at, modified_at) OVERRIDING SYSTEM VALUE VALUES (1, 'Owner', 'Owner', 1, '2023-12-29 17:32:05.52404', '2023-12-29 17:32:05.52404');
...
SELECT pg_catalog.setval('public.ohd_document_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.ohd_meter_id_seq', 1, true);
...
SELECT pg_catalog.setval('public."ohd_otp_Id_seq"', 7, true);
...
SELECT pg_catalog.setval('public.ohd_property_user_relation_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.ohd_user_communication_setting_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.ohd_user_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.ohd_user_role_master_id_seq', 1, true);
...
--
-- TOC entry 4781 (class 2606 OID 25231)
...
--
-- TOC entry 4817 (class 2606 OID 25399)
...
--
-- TOC entry 4806 (class 2606 OID 25411)
...
--
-- TOC entry 4813 (class 2606 OID 25332)
...
--
-- TOC entry 4818 (class 2606 OID 25393)
...
--
-- TOC entry 4814 (class 2606 OID 25347)
...
--
-- TOC entry 4807 (class 2606 OID 25237)
...
--
-- TOC entry 4809 (class 2606 OID 25307)
...
--
-- TOC entry 4815 (class 2606 OID 25342)
...
--
-- TOC entry 4803 (class 2606 OID 25183)
...
--
-- TOC entry 4816 (class 2606 OID 25337)
...
--
-- TOC entry 4804 (class 2606 OID 25188)
...
--
-- TOC entry 4808 (class 2606 OID 25232)
...
--
-- TOC entry 4810 (class 2606 OID 25317)
...
--
-- TOC entry 4819 (class 2606 OID 25384)
...
--
-- TOC entry 4805 (class 2606 OID 25193)
...
--
-- TOC entry 4811 (class 2606 OID 25302)
...
--
-- TOC entry 4812 (class 2606 OID 25312)
...
-- Completed on 2024-01-22 01:06:13
