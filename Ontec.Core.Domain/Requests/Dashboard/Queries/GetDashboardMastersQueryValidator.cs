...
{
    public class GetDashboardMastersQueryValidator:AbstractValidator<GetDashboardMastersQuery>
    {
        public GetDashboardMastersQueryValidator(IUserRepository _userRepository)
        {
