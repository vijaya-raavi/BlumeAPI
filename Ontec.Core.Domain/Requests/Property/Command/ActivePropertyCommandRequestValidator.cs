...
{
    public class ActivePropertyCommandRequestValidator : AbstractValidator<ActivePropertyCommandRequest>
    {
        public ActivePropertyCommandRequestValidator(IPropertyRepository _propertyRepository)
        {
